...
```{r Examine_population_size_over_time}
...
```{r Examine_simulated_trait_evolution}
...
```{r Examine_simulated_trait_variance}
...
```{r Plot_maps_without_using_the_spatial_data_class}
...
```{r plot_of_range_in_trait_quantiles_by_year_by_parameter_value}
...
```{r visual_inspection_of_simulated_data}
par(mfcol=c(3,2),
